...
| M9j | `M9j_subprocessors_ai.md` | draft — AWS opt-out live; OpenAI Sharing PNG **captured 24 Aug 2026** (`openai-data-controls.png`; Velvetelves org; all three radios Disabled) |

Also: `self_attestation_draft.md`, `compensating_controls.md` (SPA CSP Mediums, callback CSP, `localStorage` JWT, leftover pip-audit, Fluid Lows, ZAP Low-confidence Highs).
