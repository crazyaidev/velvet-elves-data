...
- **3.1.3–3.1.6** — Fail-secure 401/403, IDOR covered by M9f + auth ZAP, CSRF N/A for Bearer APIs + register limiter, no directory listing (CloudFront OAC / no static API).
