...
- Supabase JWT expiry + refresh rotation. Staging access JWT measured 31 Aug 2026: `exp − iat` = 1 hour (under 24 h; was 8 h until the owner set Sessions to 3600 s). Refresh is stateful and revocable.
