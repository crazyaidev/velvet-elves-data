/**
 * Headless shots for CASA 1.3.2 on Velvet Elves staging only.
 */
...
const OUT = path.join(__dirname, '..', 'casa_al1_evidence', 'm9', 'tac_images', '1.3.2')
...
try {
  ...
  const file = path.join(OUT, 'CASA_1_3_2_reset_expired.png')
