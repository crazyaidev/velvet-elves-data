/**
 * Headless shots for CASA 1.3.3 on Velvet Elves staging only.
 * Forgot-password (no app-minted code), success copy, expired reset page.
 */
...
const OUT = path.join(__dirname, '..', 'casa_al1_evidence', 'm9', 'tac_images', '1.3.3')
...
try {
  ...
  await shot('CASA_1_3_3_forgot_password.png')
  ...
  await shot('CASA_1_3_3_expires_1h.png')
  ...
  await page.waitForTimeout(400)
  await shot('CASA_1_3_3_reset_expired.png')
} finally {
  await browser.close()
}
