...
| K3 | Buy Google Workspace for `velvetelves.com` (decision = YES, Jake started signup 2026-07-06) | It is a paid subscription on the company, and the project currently lives under his personal Google account | In progress: signup hit Google's 24h cooldown; when the wizard reaches "verify your domain", Jake sends me the `google-site-verification=` line and I add it in Route 53 (J6 rides the same record) |
