...
### 27. All Documents page — overview and access
...
### 27.1. All Documents — search, filter tabs, side filters, and view toggle

**Route / Location**

/documents (controls below the header)
...
### 27.2. All Documents — AI Briefing and completion progress

**Route / Location**

/documents (top of the content area)
...
### 27.8. All Documents — Send for Signature

**Route / Location**

'Send for Signature' header button, row action, or Preview footer
...
### 27.12. All Documents — Archive (internal) and Flag for Deletion (non-internal)
