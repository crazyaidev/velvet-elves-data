...
### 12. Onboarding wizard (rewritten — role-aware flow)
...
### 13. Product Tour overlay (rebuilt — role-aware spotlight tour)
...
### 29. Settings page — overview and layout (rebuilt)
...
### 29.1. Settings — Email Integrations (Milestone 4.1 — required for AI Email Review)
...
### 29.3. Settings — Branding (visual-only — please do NOT rely on this yet)
...
### 29.4. Settings — AI Configuration (visual-only toggles)
...
### 29.5. Settings — Task Templates (visual-only)
...
### 29.7. AI Email Review — overview, list, and filter tabs (Milestone 4.2)
...
### 29.8. AI Email Review — list pane row anatomy

**Route / Location**

/ai-emails (left list pane)
...
### 29.9. AI Email Review — detail pane (AI Verified From + Original Inbound + flagged assumptions)

**Route / Location**

/ai-emails (right detail pane)
...
### 29.10. AI Email Review — actions (Approve & Send, Edit & Send, Regenerate, Discard)

**Route / Location**

/ai-emails (action footer on the detail pane)
