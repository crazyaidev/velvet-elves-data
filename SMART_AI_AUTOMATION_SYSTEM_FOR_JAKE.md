# Smart AI Automation — What It Does, What's Next, and What I Need From You
...
Please tick one box per question. If it is easier to talk than to write, I am happy to jump on a call. The first five change what buyers, sellers, lenders, and title reps see.
...
- [ ] Agreed: automate reminders only (my recommendation)
...
- [ ] I want additional letters automatic now — list: _______________________________
...
- [ ] Defer. Do not build it yet (my recommendation)
...
- [ ] Start Manual; Autopilot is opt-in only (my recommendation)
- [ ] Start Assisted
- [ ] Start Autopilot
...
- [ ] I meant task 245
- [ ] I meant task 230
- [ ] 235 is a new task — details: _______________________________
...
- [ ] Add both with those settings (my recommendation)
...
- [ ] Rename to Request Testimonials and write a review request (my recommendation)
...
- [ ] Appendix A approved
- [ ] Appendix A approved with notes: _______________________________
- [ ] I will mark it up in the Google Doc
...
- [ ] You choose sensible defaults and I will correct them (my recommendation if you are short on time)
- [ ] Skip it for now
...
- [ ] Rename deal Autopilot to something else — suggestion: _______________________________
- [ ] Let's discuss on a call (my recommendation)
