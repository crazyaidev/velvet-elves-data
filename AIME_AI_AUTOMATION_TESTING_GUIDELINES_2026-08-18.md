...
Admin: Settings → AI & Automation → Preview next tick
...
Admin: Preview next tick, then **Run AI tasks (sends deal email)** only if would-send is entirely yours.
...
Settings → AI & Automation → Inspection reminders (Admin / owner)  
